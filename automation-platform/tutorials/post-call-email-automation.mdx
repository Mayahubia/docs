...
<Frame>
  ![Webhook trigger configuration](/06-webhook-settings.avif)
</Frame>
...
<Frame>
  ![Post-call variables for email content](/07-post-call-variables.avif)
</Frame>
...
<Frame>
  ![Call variables including email collection](/08-set-test-values.avif)
</Frame>
