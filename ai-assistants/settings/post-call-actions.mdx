...
<AccordionGroup>
  ...
  <Accordion title="Webhook URL" icon="link">
    ...
    **Exemplo:** [https://automate.mayahub.ai/api/v1/webhooks/your-webhook-id]
...
```json
{
  ...
  "transcript": [
    {
      "text": "Hello! This is Sarah from Mayahub.",
      "type": "transcript",
      "sender": "bot",
  ...
  "formatted_transcript": "AI: Hello! This is Sarah from Mayahub.\\nCustomer: Hi, I'm doing well, thanks.",
